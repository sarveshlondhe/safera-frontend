...
import { Zap, Megaphone, Building2, PhoneCall, Users, Siren, LogOut, CheckCircle, RefreshCw, X, Send, Globe, Flame } from "lucide-react";
          ...
          <>
            ...
            <div style={{ background: c.card, border: `1px solid ${c.border}`, borderRadius: 18, padding: 14 }}>
              ...
              {[
                ...
                { icon: <Flame size={18} color="#FF6B35" />, title: "🔥 Fire Assessment",  desc: "Automated fire damage engine",          action: () => navigate("/fire") },
